...
NA means the data is 'not available' The mean and median may be NA due to an NA in the data frame
...
Na.rm = true removes NA values from calculations 
...
**Write your answer here**
This suggests that on some occasions (eg. public holidays and weekends) there may be a large spike in the amount of visitors, beinging up the mean but not the median values.
